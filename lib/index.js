...
(function() {
	...
	JadeAngularJsCompiler.prototype.prepareResult = function(compiled) {
	    console.log("##### prepareResult", Object.keys(compiled), this.compileTrigger, compiled)
	    var pathes,
		_this = this;
	    
	    pathes = _.find(compiled, function(v) {
		console.log("##### find", v.path)
		return v.path === _this.compileTrigger;
	    });
	    console.log("##### prepareResult pathes", pathes == null || Object.keys(pathes))
	    if (pathes === void 0) {
		return [];
	    }
	...
	JadeAngularJsCompiler.prototype.onCompile = function(compiled) {
	    ...
	    console.log("##### preResult", preResult.length)
